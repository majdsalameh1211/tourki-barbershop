    ...
    <div className="card-view-container">
      ...
      <div className="card-viewer-wrapper">
        ...
        <div className="data-row">
          <span className="data-label">נוצר בתאריך</span>
          <span className="data-value">
            {new Date(appointment.createdAt).toLocaleDateString('he-IL')}
            <span style={{ color: '#9CA3AF', fontWeight: 400, margin: '0 4px' }}>|</span>
            {new Date(appointment.createdAt).toLocaleTimeString('he-IL', { hour: '2-digit', minute: '2-digit' })}
          </span>
        </div>
